      ...
      0000A5 02 00 49         [24]  356 	ljmp	__sdcc_program_startup
                                    357 ;--------------------------------------------------------
                                    358 ; Home
                                    359 ;--------------------------------------------------------
                                    360 	.area HOME    (CODE)
                                    361 	.area HOME    (CODE)
      000049                        362 __sdcc_program_startup:
      000049 02 01 12         [24]  363 	ljmp	_main
                                    ...
                                    368 	.area CSEG    (CODE)
                                    369 ;------------------------------------------------------------
                                    370 ;Allocation info for local variables in function 'uart_init'
                                    371 ;------------------------------------------------------------
                                    372 ;	test.c:4: void uart_init() {
                                    373 ;	-----------------------------------------
                                    374 ;	 function uart_init
                                    375 ;	-----------------------------------------
      0000A8                        376 _uart_init:
                           000007   377 	ar7 = 0x07
                           000006   378 	ar6 = 0x06
                           000005   379 	ar5 = 0x05
                           000004   380 	ar4 = 0x04
                           ...
                           000001   383 	ar1 = 0x01
                           000000   384 	ar0 = 0x00
                                    385 ;	test.c:5: SCON = 0x50;  // 模式1, 8位数据, 可接收
      0000A8 75 98 50         [24]  386 	mov	_SCON,#0x50
                                    387 ;	test.c:6: TMOD |= 0x20; // 定时器1，模式2 (8位自动重装)
      0000AB 43 89 20         [24]  388 	orl	_TMOD,#0x20
                                    389 ;	test.c:7: TH1 = 0xFD;   // 9600 波特率
      0000AE 75 8D FD         [24]  390 	mov	_TH1,#0xfd
                                    391 ;	test.c:8: TL1 = 0xFD;
      0000B1 75 8B FD         [24]  392 	mov	_TL1,#0xfd
                                    393 ;	test.c:9: TR1 = 1;      // 启动定时器1
                                    394 ;	assignBit
      0000B4 D2 8E            [12]  395 	setb	_TR1
                                    396 ;	test.c:10: TI = 1;       // 设置发送中断标志以允许打印
                                    397 ;	assignBit
      0000B6 D2 99            [12]  398 	setb	_TI
                                    399 ;	test.c:11: }
      0000B8 22               [24]  400 	ret
                                    401 ;------------------------------------------------------------
                                    402 ;Allocation info for local variables in function 'putchar'
                                    403 ;------------------------------------------------------------
                                    404 ;c             Allocated to registers r7 
                                    405 ;------------------------------------------------------------
                                    406 ;	test.c:13: void putchar(char c) {
                                    407 ;	-----------------------------------------
                                    408 ;	 function putchar
                                    409 ;	-----------------------------------------
      0000B9                        410 _putchar:
      0000B9 AF 82            [24]  411 	mov	r7, dpl
                                    412 ;	test.c:14: while (!TI);  // 等待上一个字节发送完成
      0000BB                        413 00101$:
                                    414 ;	test.c:15: TI = 0;
                                    415 ;	assignBit
      0000BB 10 99 02         [24]  416 	jbc	_TI,00118$
      0000BE 80 FB            [24]  417 	sjmp	00101$
      0000C0                        418 00118$:
                                    419 ;	test.c:16: SBUF = c;
      0000C0 8F 99            [24]  420 	mov	_SBUF,r7
                                    421 ;	test.c:17: }
      0000C2 22               [24]  422 	ret
                                    423 ;------------------------------------------------------------
                                    424 ;Allocation info for local variables in function 'print_str'
                                    425 ;------------------------------------------------------------
                                    426 ;s             Allocated to registers 
                                    427 ;------------------------------------------------------------
                                    428 ;	test.c:19: void print_str(char *s) {
                                    429 ;	-----------------------------------------
                                    430 ;	 function print_str
                                    431 ;	-----------------------------------------
      0000C3                        432 _print_str:
      0000C3 AD 82            [24]  433 	mov	r5, dpl
      0000C5 AE 83            [24]  434 	mov	r6, dph
      0000C7 AF F0            [24]  435 	mov	r7, b
                                    436 ;	test.c:20: while (*s) {
      0000C9                        437 00101$:
      0000C9 8D 82            [24]  438 	mov	dpl,r5
      0000CB 8E 83            [24]  439 	mov	dph,r6
      0000CD 8F F0            [24]  440 	mov	b,r7
      0000CF 12 01 26         [24]  441 	lcall	__gptrget
      0000D2 FC               [12]  442 	mov	r4,a
      0000D3 60 18            [24]  443 	jz	00104$
                                    444 ;	test.c:21: putchar(*s++);
      0000D5 8C 82            [24]  445 	mov	dpl,r4
      0000D7 0D               [12]  446 	inc	r5
      0000D8 BD 00 01         [24]  447 	cjne	r5,#0x00,00120$
      0000DB 0E               [12]  448 	inc	r6
      0000DC                        449 00120$:
      0000DC C0 07            [24]  450 	push	ar7
      0000DE C0 06            [24]  451 	push	ar6
      0000E0 C0 05            [24]  452 	push	ar5
      0000E2 12 00 B9         [24]  453 	lcall	_putchar
      0000E5 D0 05            [24]  454 	pop	ar5
      0000E7 D0 06            [24]  455 	pop	ar6
      0000E9 D0 07            [24]  456 	pop	ar7
      0000EB 80 DC            [24]  457 	sjmp	00101$
      0000ED                        458 00104$:
                                    459 ;	test.c:23: }
      0000ED 22               [24]  460 	ret
                                    461 ;------------------------------------------------------------
                                    462 ;Allocation info for local variables in function 'delay'
                                    463 ;------------------------------------------------------------
                                    464 ;ms            Allocated to registers r6 r7 
                                    465 ;i             Allocated to registers r4 r5 
                                    466 ;j             Allocated to registers r2 r3 
                                    467 ;------------------------------------------------------------
                                    468 ;	test.c:25: void delay(unsigned int ms) {
                                    469 ;	-----------------------------------------
                                    470 ;	 function delay
                                    471 ;	-----------------------------------------
      0000EE                        472 _delay:
      0000EE AE 82            [24]  473 	mov	r6, dpl
      0000F0 AF 83            [24]  474 	mov	r7, dph
                                    475 ;	test.c:27: for (i = 0; i < ms; i++)
      0000F2 7C 00            [12]  476 	mov	r4,#0x00
      0000F4 7D 00            [12]  477 	mov	r5,#0x00
      0000F6                        478 00107$:
      0000F6 C3               [12]  479 	clr	c
      0000F7 EC               [12]  480 	mov	a,r4
      0000F8 9E               [12]  481 	subb	a,r6
      0000F9 ED               [12]  482 	mov	a,r5
      0000FA 9F               [12]  483 	subb	a,r7
      0000FB 50 14            [24]  484 	jnc	00109$
                                    485 ;	test.c:28: for (j = 0; j < 120; j++);
      0000FD 7A 78            [12]  486 	mov	r2,#0x78
      0000FF 7B 00            [12]  487 	mov	r3,#0x00
      000101                        488 00105$:
      000101 1A               [12]  489 	dec	r2
      000102 BA FF 01         [24]  490 	cjne	r2,#0xff,00138$
      000105 1B               [12]  491 	dec	r3
      000106                        492 00138$:
      000106 EA               [12]  493 	mov	a,r2
      000107 4B               [12]  494 	orl	a,r3
      000108 70 F7            [24]  495 	jnz	00105$
                                    496 ;	test.c:27: for (i = 0; i < ms; i++)
      00010A 0C               [12]  497 	inc	r4
      00010B BC 00 E8         [24]  498 	cjne	r4,#0x00,00107$
      00010E 0D               [12]  499 	inc	r5
      00010F 80 E5            [24]  500 	sjmp	00107$
      000111                        501 00109$:
                                    502 ;	test.c:29: }
      000111 22               [24]  503 	ret
                                    504 ;------------------------------------------------------------
                                    505 ;Allocation info for local variables in function 'main'
                                    506 ;------------------------------------------------------------
                                    507 ;	test.c:31: void main() {
                                    508 ;	-----------------------------------------
                                    509 ;	 function main
                                    510 ;	-----------------------------------------
      000112                        511 _main:
                                    512 ;	test.c:32: uart_init();
      000112 12 00 A8         [24]  513 	lcall	_uart_init
                                    514 ;	test.c:33: while (1) {
      000115                        515 00102$:
                                    516 ;	test.c:34: print_str("Hello from Arch Linux!\r\n");
      000115 90 01 46         [24]  517 	mov	dptr,#___str_0
      000118 75 F0 80         [24]  518 	mov	b, #0x80
      00011B 12 00 C3         [24]  519 	lcall	_print_str
                                    520 ;	test.c:35: delay(1000);
      00011E 90 03 E8         [24]  521 	mov	dptr,#0x03e8
      000121 12 00 EE         [24]  522 	lcall	_delay
                                    523 ;	test.c:37: }
      000124 80 EF            [24]  524 	sjmp	00102$
                                    525 	.area CSEG    (CODE)
                                    526 	.area CONST   (CODE)
                                    527 	.area CONST   (CODE)
      000146                        528 ___str_0:
      000146 48 65 6C 6C 6F 20 66   529 	.ascii "Hello from Arch Linux!"
             72 6F 6D 20 41 72 63
             68 20 4C 69 6E 75 78
             21
      00015C 0D                     530 	.db 0x0d
      00015D 0A                     531 	.db 0x0a
      00015E 00                     532 	.db 0x00
                                    533 	.area CSEG    (CODE)
                                    534 	.area XINIT   (CODE)
